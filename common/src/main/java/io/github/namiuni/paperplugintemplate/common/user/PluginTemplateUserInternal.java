...
/// allows [PluginTemplateUserServiceInternal] to read and update profiles
...
@NullMarked
public interface PluginTemplateUserInternal extends PluginTemplateUser {

    /// Returns the current [UserProfile] snapshot held by this user.
    ///
    /// The returned value reflects the most recently committed write from
    /// [#updateProfile]. Because [UserProfile] is an immutable record, the
    ...
    void updateProfile(UnaryOperator<UserProfile> operator);
}
